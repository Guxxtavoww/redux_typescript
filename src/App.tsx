...
const App: React.FC = () => {
    ...
    const reservetions = useSelector((state: RootState) => state.reservation.value);
            ...
            <div className="container">
                <div className="reservation-container">
                    ...
                    <div className="reservation-input-container">
                        <input type="text" placeholder="Adicionar uma Reserva" onChange={e => setReservation(e.target.value)} value={reservation} autoFocus />
                ...
                <div className="customer-food-container">
                    {
                        costumers.length ? (
                            costumers?.map((cliente, index) => (
                                <CustomerCard name={cliente.name} id={cliente.id} foods={cliente.food} key={index} />
                            ))
                        ) : (
